...
local window = library:new("TB脚本（3290274245制作）")
...
local creds = window:Tab("整合",'6035145364')

local tool = creds:section("功能",true)

tool:Button("达脚本",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/133ufudhdu/QuQ/main/etjgsuet"))()
end)

tool:Button("白",function()
...
tool:Button("青",function()
loadstring(game:HttpGet('https://rentry.co/ct293/raw'))()
end)

tool:Button("陈",function()
...
local creds = window:Tab("合作",'6035145364')
